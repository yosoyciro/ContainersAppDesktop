...
public class MovimDTO
{
    ...
    public string MOVIM_TIPO_MOVIM_DESCRIPCION
    {
        get;
        set;
    }
    ...
    public string MOVIM_PESO_DESCRIPCION
    {
        get;
        set;
    }
    ...
    public string MOVIM_TRANSPORTISTA_DESCRIPCION
    {
        get;
        set;
    }
    ...
    public string MOVIM_CLIENTE_DESCRIPCION
    {
        get;
        set;
    }
    ...
    public string MOVIM_CHOFER_DESCRIPCION
    {
        get;
        set;
    }
    ...
    public string MOVIM_ENTRADA_SALIDA_DESCRIPCION
    {
        get;
        set;
    }
    ...
    public string MOVIM_ALMACEN_DESCRIPCION
    {
        get;
        set;
    }
