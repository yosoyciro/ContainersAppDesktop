...
public class ObjetosServicio
{    
    //private readonly ILogger<ObjetosServicio> _logger;

    //public ObjetosServicio(ILogger<ObjetosServicio> logger)
    //{        
    //    _logger = logger;
    //}

    //#region Actualizar
    //public async Task<bool> ActualizarObjeto(Objeto objeto)
    //{
    ...
    //            updateCommand.Parameters.AddWithValue("@OBJ_ID_REG", objeto.ID);
    ...
    //#region CrearObjeto
    //public async Task<int> CrearObjeto(Objeto objeto)
    //{
    //    using (SqliteConnection db = new SqliteConnection($"Filename={_dbFullPath}"))
    //    {
    //        try
    ...
    //public async Task<List<Objeto>> ObtenerObjetos()
    //{
    ...
    //public async Task<Objeto> ObtenerObjetoPorId(int id)
    //{     
    ...
    //public async Task<bool> BorrarRecuperarRegistro(Objeto objeto)
    //{
    //    using (SqliteConnection db = new SqliteConnection($"Filename={_dbFullPath}"))
    //    {
    //        try
    ...
    //            deleteCommand.Parameters.AddWithValue("@OBJ_ID_REG", objeto.ID);
